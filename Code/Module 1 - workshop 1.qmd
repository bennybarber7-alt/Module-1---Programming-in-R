...
print (my_quiz)        # spelling mistake in print function
str(my_quiz)
length(my_quiz)       # functoin not real, real functoin = length
...
## Installing packages
packacges include tidyverse, ggplot2, earthtones, redlistr, terra:
